  ...
  <div class="admin-dashboard">
    ...
    <div class="quick-actions">
      ...
      <div class="action-buttons">
        ...
        <router-link to="/admin/appeals" class="action-btn appeal-btn">
          <span>📝</span>
          <span>申诉管理</span>
          <span v-if="stats.pendingAppeals > 0" class="badge">{{ stats.pendingAppeals > 99 ? '99+' : stats.pendingAppeals }}</span>
        </router-link>
      </div>
    </div>
  </div>
